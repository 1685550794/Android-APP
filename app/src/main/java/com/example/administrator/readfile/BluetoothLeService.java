...
public class BluetoothLeService extends Service {
    ...
    public final static UUID UUID_BLE_SPP_NOTIFY = UUID.fromString(BleYLBGattAttributes.BLE_SPP_Notify_Characteristic);
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                BluetoothGattService service = gatt.getService(UUID.fromString(BleYLBGattAttributes.BLE_SPP_Service));
                if (service!=null)
                {
                    //找到服务，继续查找特征值
                    mNotifyCharacteristic = service.getCharacteristic(UUID.fromString(BleYLBGattAttributes.BLE_SPP_Notify_Characteristic));
                    mWriteCharacteristic  = service.getCharacteristic(UUID.fromString(BleYLBGattAttributes.BLE_SPP_Write_Characteristic));
                }
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        if (UUID_BLE_SPP_NOTIFY.equals(characteristic.getUuid())) {
            BluetoothGattDescriptor descriptor = characteristic.getDescriptor(
                    UUID.fromString(BleYLBGattAttributes.CLIENT_CHARACTERISTIC_CONFIG));
